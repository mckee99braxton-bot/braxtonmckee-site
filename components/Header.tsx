  ...
  return (
    <header className="mx-auto flex w-full max-w-[1120px] items-center justify-between gap-6 px-5 py-6 text-sm text-ink sm:px-8">
      <Link href="/" className="focus-ring flex flex-col leading-tight sm:flex-row sm:items-baseline sm:gap-3">
        <span className="font-semibold text-ink">Braxton McKee</span>
      ...
      <nav className="flex items-center gap-5 text-sm font-semibold text-[var(--muted)]">
        <Link href="/writing" className="focus-ring border-b border-transparent pb-1 hover:border-[var(--wash)] hover:text-[var(--wash)]">
          Insights
        </Link>
        <a
          href={linkedInUrl}
